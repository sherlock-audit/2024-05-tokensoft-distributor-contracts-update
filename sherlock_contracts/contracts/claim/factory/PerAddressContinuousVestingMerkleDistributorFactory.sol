...
import {PerAddressContinuousVestingMerkleDistributor} from "./PerAddressContinuousVestingMerkleDistributor.sol";

contract PerAddressContinuousVestingMerkleDistributorFactory {
    ...
    function deployDistributor(
        ...
        public
        returns (PerAddressContinuousVestingMerkleDistributor distributor)
    {
        ...
        distributor = PerAddressContinuousVestingMerkleDistributor(
            Clones.cloneDeterministic(i_implementation, salt)
        );
