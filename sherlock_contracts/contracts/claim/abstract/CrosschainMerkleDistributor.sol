 ...
 */
abstract contract CrosschainMerkleDistributor is
    ...
    MerkleSet
{
    ...
    function initializeDistributionRecord(
        ...
        external
        validMerkleProof(_getLeaf(_beneficiary, _amount, _domain), merkleProof)
    {
    ...
    function xReceive(
        ...
        _verifyMembership(
            _getLeaf(beneficiary, totalAmount, beneficiaryDomain),
            proof
        );
    ...
    function claimBySignature(
        ...
        // Validate the claim
        _verifyMembership(
            _getLeaf(_beneficiary, _total, _beneficiaryDomain),
            _proof
        );
        uint256 claimedAmount = _executeClaim(
            _beneficiary,
