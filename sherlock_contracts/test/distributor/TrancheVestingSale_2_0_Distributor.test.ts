...
describe("TrancheVestingSale_2_0", function () {
  beforeAll(async () => {
    [deployer, admin, recipient, buyer0, buyer1, buyer2, buyer3, buyer4, buyer5, nonBuyer, feeRecipient ] = await ethers.getSigners();
  ...
  it("Initial setup matches sale correctly", async () => {
    ...
    const boughtTokens = (signer: any) => buyers.includes(signer)
